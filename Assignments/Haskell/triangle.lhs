...
> triangle (a, b, c)
>   | a <= 0 || b <= 0 || c <= 0 = Illegal
>   | ((a + b) < c) || ((a + c) < b) || ((b + c) < a) = Impossible
>   | (a + b) == c || (a + c) == b || (b + c) == a = Flat
>   | a == b && b == c = Equilateral
>   | (a == b && b /= c) || (a == c && c /= b) || (b == c && c /= a) = Isosceles
>   | ((a*a + b*b) == c*c) || ((b*b + c*c) == a*a) || ((a*a + c*c) == b*b) = RightAngled
>   | otherwise = Scalene
...
> isTriangle t = not (triangle t == Impossible || triangle t == Illegal) --DONE
...
n triangles produced by `triangles`.

> ex1 :: Int -> Int
> ex1 n = length(filter isIsos (take n triangles)) --DONE

> isIsos :: Triple -> Bool
> isIsos t = (triangle t == Isosceles)
