...
> -- TODO #S4b:
> cols :: Sudoku -> [[Cell]]
> cols (Sudoku cells) = transpose(bundle 9 cells)

> -- TODO #S4c:
> boxs :: Sudoku -> [[Cell]]
> boxs (Sudoku cells) = (concatMap(map concat.transpose).bundle 3.bundle 3.bundle 3) cells
...
to understand how this work at this point in the course.
